...
<table>
  <tr>
    <td align="center"><img src="./assets/show-1.jpg" alt="未识别状态" width="200" height="444" style="background:#e0e4e8; border-radius:4px"><br>未识别状态</td>
    <td align="center"><img src="./assets/show-2.jpg" alt="已识别状态" width="200" height="444" style="background:#e0e4e8; border-radius:4px"><br>已识别状态</td>
    <td align="center"><img src="./assets/show-1.gif" alt="操作演示，正在加载。。。" width="200" height="444" style="background:#e0e4e8; border-radius:4px"><br>操作演示</td>
  </tr>
</table>
